...
import styles from './SideMenuMinimized.module.css';
import MinimizedMenuOptionItem from '../MinimizedMenuOptionItem/MinimizedMenuOptionItem';

function SideMenuMinimized() {
  return (
    <div className={styles.sideMenuMinimized}>

      <MinimizedMenuOptionItem title="Inicio">
        <svg
      ...
      </MinimizedMenuOptionItem>

      <MinimizedMenuOptionItem title="Shorts">
        <svg
          className="style-scope yt-icon"
          display="block"
          pointerEvents="none"
      ...
      <MinimizedMenuOptionItem title="Suscripciones">
        <svg
          className="style-scope yt-icon"
          display="block"
          pointerEvents="none"
      ...
      <MinimizedMenuOptionItem title="Mi biblioteca">
        <svg
          className="style-scope yt-icon"
          display="block"
          pointerEvents="none"
